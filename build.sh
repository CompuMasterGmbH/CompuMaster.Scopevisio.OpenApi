...
${nuget_cmd} install src/CompuMaster.Scopevisio.OpenApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/CompuMaster.Scopevisio.OpenApi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/CompuMaster.Scopevisio.OpenApi.dll \
-recurse:'src/CompuMaster.Scopevisio.OpenApi/*.cs' \
-doc:bin/CompuMaster.Scopevisio.OpenApi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/CompuMaster.Scopevisio.OpenApi.dll was created successfully"
fi
