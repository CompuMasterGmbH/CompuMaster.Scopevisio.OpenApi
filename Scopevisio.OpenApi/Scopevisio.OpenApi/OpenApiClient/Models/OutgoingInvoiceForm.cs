...
namespace CompuMaster.Scopevisio.OpenApi.Models
{
    ...
    public partial class OutgoingInvoiceForm
    {
        /// <summary>
        /// Initializes a new instance of the OutgoingInvoiceForm class.
        /// </summary>
        ...
        /// <summary>
        /// locale (Sprache). If not provided by the user the
        /// language(Sprache) from the contact with the given
        /// "customerContactId" is used. To be set correctly in the invoice
        /// the locale must be also set in the Scopevisio client application
        /// under "Stammdaten" &gt; "Sprachen und Textbausteine" &gt;
        /// "Sprachen für Aufgragsbelege bearbeiten". Otherwise the locale of
        /// the invoice is set to "Deutsch".
        /// </summary>
        [JsonProperty(PropertyName = "locale")]
        public string Locale { get; set; }

        /// <summary>
        /// currency(Währung), the ISO 4217 alphabetic currency code. If
        /// currency is provided there must be an exchange rate specified -
        /// either via the parameter "exchangeRate" or set in the Scopevisio
        /// client application. If currency is not provided, the currency
        /// from the contact with the given "customerContactId" is used.
        /// </summary>
        [JsonProperty(PropertyName = "currency")]
        public string Currency { get; set; }

        /// <summary>
        /// exchangeRate(Wechselkurs), evaluated only if "curency" is set. If
        /// not provided in the request an exchange rate must be configured
        /// in the Scopevisio client application.
        /// </summary>
