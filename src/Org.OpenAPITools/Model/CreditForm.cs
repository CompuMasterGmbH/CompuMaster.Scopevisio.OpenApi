...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreditForm :  IEquatable<CreditForm>, IValidatableObject
    {
        /// <summary>
        /// stateName (Status der Gutschrift). Sets also state.
        /// </summary>
        /// <value>stateName (Status der Gutschrift). Sets also state.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum StateNameEnum
        {
            /// <summary>
            /// Enum Erstellt for value: erstellt
            /// </summary>
            [EnumMember(Value = "erstellt")]
            Erstellt = 1,

            /// <summary>
            /// Enum Nichtbezahlt for value: nicht bezahlt
            /// </summary>
            [EnumMember(Value = "nicht bezahlt")]
            Nichtbezahlt = 2,

            /// <summary>
            /// Enum Bezahlt for value: bezahlt
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreditForm" /> class.
        /// </summary>
        ...
        /// <param name="stateName">stateName (Status der Gutschrift). Sets also state..</param>
        /// <param name="postingDate">postingDate (Buchungsdatum). .</param>
        /// <param name="documentText">documentText (Belegtext)..</param>
        /// <param name="locale">locale (Sprache).</param>
        public CreditForm(long projectId = default(long), long customerContactId = default(long), string name = default(string), string text = default(string), long customerContactPerson = default(long), long documentDate = default(long), string documentNumber = default(string), string ourContactPerson = default(string), string deliveryType = default(string), decimal deliveryCosts = default(decimal), decimal cashOnDelivery = default(decimal), string textTitle = default(string), string textSubTitle = default(string), string textIntro = default(string), string textExtro = default(string), long selectedAddress = default(long), string otherAddress = default(string), bool gross = false, long permissionType = default(long), string readPermissionProfiles = default(string), string readPermissionLogins = default(string), string writePermissionProfiles = default(string), string writePermissionLogins = default(string), List<CustomField> customFields = default(List<CustomField>), PositionsForm positionsForm = default(PositionsForm), string orderNumber = default(string), string zoneNumber = default(string), StateNameEnum? stateName = default(StateNameEnum?), long postingDate = default(long), string documentText = default(string), string locale = default(string))
        {
            // to ensure "customerContactId" is required (not null)
            if (customerContactId == null)
            {
                throw new InvalidDataException("customerContactId is a required property for CreditForm and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentDate is a required property for CreditForm and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>documentText (Belegtext).</value>
        ...
        {
            return this.Equals(input as CreditForm);
        }

        /// <summary>
        /// Returns true if CreditForm instances are equal
        /// </summary>
        /// <param name="input">Instance of CreditForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreditForm input)
        {
            if (input == null)
                return false;
