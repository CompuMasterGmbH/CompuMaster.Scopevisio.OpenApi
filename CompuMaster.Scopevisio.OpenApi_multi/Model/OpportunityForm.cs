...
namespace CompuMaster.Scopevisio.OpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OpportunityForm :  IEquatable<OpportunityForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// state (PZ-Status). Sets also state.
        /// </summary>
        /// <value>state (PZ-Status). Sets also state.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum StateNameEnum
        {
            /// <summary>
            /// Enum Identifiziert for value: identifiziert
            /// </summary>
            [EnumMember(Value = "identifiziert")]
            Identifiziert = 1,
            ...
            /// <summary>
            /// Enum Qualifiziert for value: qualifiziert
            /// </summary>
            [EnumMember(Value = "qualifiziert")]
            Qualifiziert = 3,

            /// <summary>
            /// Enum Berfhrt for value: überführt
            /// </summary>
            [EnumMember(Value = "überführt")]
            Berfhrt = 4,

            /// <summary>
            /// Enum Verworfen for value: verworfen
            /// </summary>
            [EnumMember(Value = "verworfen")]
            Verworfen = 5
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpportunityForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OpportunityForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OpportunityForm" /> class.
        /// </summary>
        ...
        public OpportunityForm(long projectId = default(long), long customerContactId = default(long), string name = default(string), string text = default(string), long customerContactPerson = default(long), long documentDate = default(long), string documentNumber = default(string), string ourContactPerson = default(string), string deliveryType = default(string), decimal deliveryCosts = default(decimal), decimal cashOnDelivery = default(decimal), string textTitle = default(string), string textSubTitle = default(string), string textIntro = default(string), string textExtro = default(string), long selectedAddress = default(long), string otherAddress = default(string), bool gross = false, long permissionType = default(long), string readPermissionProfiles = default(string), string readPermissionLogins = default(string), string writePermissionProfiles = default(string), string writePermissionLogins = default(string), List<CustomField> customFields = default(List<CustomField>), PositionsForm positionsForm = default(PositionsForm), long deliveryDate = default(long), long deliveryDateTo = default(long), bool isEndDiscountAbsolute = false, decimal endDiscount = default(decimal), PaymentTypeNameEnum? paymentTypeName = default(PaymentTypeNameEnum?), bool isPaid = false, long discountDate1 = default(long), long discountDate2 = default(long), long dueDate = default(long), decimal discountPercent1 = default(decimal), decimal discountPercent2 = default(decimal), bool explicitDiscount = false, decimal discountAmount1 = default(decimal), decimal discountAmount2 = default(decimal), SalesPhaseEnum? salesPhase = default(SalesPhaseEnum?), SalesClassificationEnum? salesClassification = default(SalesClassificationEnum?), SalesActivityEnum? salesActivity = default(SalesActivityEnum?), PhaseEnum? phase = default(PhaseEnum?), decimal feasibility = default(decimal), long closingDateTs = default(long), long reminderDateTs = default(long), StateNameEnum? stateName = default(StateNameEnum?))
        {
            ...
            {
                throw new InvalidDataException("documentDate is a required property for OpportunityForm and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpportunityForm {\n");
        ...
        {
            return this.Equals(input as OpportunityForm);
        }

        /// <summary>
        /// Returns true if OpportunityForm instances are equal
        /// </summary>
        /// <param name="input">Instance of OpportunityForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpportunityForm input)
        {
            if (input == null)
                return false;
