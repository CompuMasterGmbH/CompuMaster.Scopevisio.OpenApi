...
namespace CompuMaster.Scopevisio.OpenApi.Api
{
    ...
    public partial class ActivitiesApi  
    {
        ...
        /// <returns></returns>
        public ActivitiesApi(CompuMaster.Scopevisio.OpenApi.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// events Returns Events of Scopevisio.  Required profile(s): &lt;i&gt;Rechnungseingangsbuch (Anzeigen)&lt;/i&gt;.
        /// </summary>
        ...
        /// <returns></returns>
        public void GetEvents (string body = default(string))
        {
             GetEventsWithHttpInfo(body);
        }
        ...
        public ApiResponse<Object> GetEventsWithHttpInfo (string body = default(string))
        {
        ...
        public async System.Threading.Tasks.Task GetEventsAsync (string body = default(string))
        {
             await GetEventsAsyncWithHttpInfo(body);
        ...
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetEventsAsyncWithHttpInfo (string body = default(string))
        {
