...
namespace CompuMaster.Scopevisio.OpenApi.Test
{
    ...
    public class OrganisationApiTests
    {
        ...
        public void Init()
        {
            instance = new OrganisationApi(new TestConfig());
        }
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' OrganisationApi
            //Assert.IsInstanceOf(typeof(OrganisationApi), instance);
        }
        ...
        public void CreateOrganisationTest()
        {
            ...
            //OrganisationForm body = null;
            //instance.CreateOrganisation(body);
