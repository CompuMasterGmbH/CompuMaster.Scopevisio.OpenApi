...
namespace CompuMaster.Scopevisio.OpenApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OutgoingInvoiceForm :  IEquatable<OutgoingInvoiceForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OutgoingInvoiceForm" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OutgoingInvoiceForm() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OutgoingInvoiceForm" /> class.
        /// </summary>
        ...
        /// <param name="postingDate">postingDate (Buchungsdatum). .</param>
        /// <param name="documentText">documentText (Rechnungstext)..</param>
        /// <param name="locale">locale (Sprache). If not provided by the user the language(Sprache) from the contact with the given \&quot;customerContactId\&quot; is used. To be set correctly in the invoice the locale must be also set in the Scopevisio client application under \&quot;Stammdaten\&quot; &gt; \&quot;Sprachen und Textbausteine\&quot; &gt; \&quot;Sprachen für Aufgragsbelege bearbeiten\&quot;. Otherwise the locale of the invoice is set to \&quot;Deutsch\&quot;..</param>
        /// <param name="currency">currency(Währung), the ISO 4217 alphabetic currency code. If currency is provided there must be an exchange rate specified - either via the parameter \&quot;exchangeRate\&quot; or set in the Scopevisio client application. If currency is not provided, the currency from the contact with the given \&quot;customerContactId\&quot; is used..</param>
        /// <param name="exchangeRate">exchangeRate(Wechselkurs), evaluated only if \&quot;curency\&quot; is set. If not provided in the request an exchange rate must be configured in the Scopevisio client application..</param>
        public OutgoingInvoiceForm(long projectId = default(long), long customerContactId = default(long), string name = default(string), string text = default(string), long customerContactPerson = default(long), long documentDate = default(long), string documentNumber = default(string), string ourContactPerson = default(string), string deliveryType = default(string), decimal deliveryCosts = default(decimal), decimal cashOnDelivery = default(decimal), string textTitle = default(string), string textSubTitle = default(string), string textIntro = default(string), string textExtro = default(string), long selectedAddress = default(long), string otherAddress = default(string), bool gross = false, long permissionType = default(long), string readPermissionProfiles = default(string), string readPermissionLogins = default(string), string writePermissionProfiles = default(string), string writePermissionLogins = default(string), List<CustomField> customFields = default(List<CustomField>), PositionsForm positionsForm = default(PositionsForm), long deliveryDate = default(long), long deliveryDateTo = default(long), bool isEndDiscountAbsolute = false, decimal endDiscount = default(decimal), PaymentTypeNameEnum? paymentTypeName = default(PaymentTypeNameEnum?), bool isPaid = false, long discountDate1 = default(long), long discountDate2 = default(long), long dueDate = default(long), decimal discountPercent1 = default(decimal), decimal discountPercent2 = default(decimal), bool explicitDiscount = false, decimal discountAmount1 = default(decimal), decimal discountAmount2 = default(decimal), string orderNumber = default(string), string zoneNumber = default(string), long postingDate = default(long), string documentText = default(string), string locale = default(string), string currency = default(string), decimal exchangeRate = default(decimal))
        {
            // to ensure "customerContactId" is required (not null)
            if (customerContactId == null)
            {
                throw new InvalidDataException("customerContactId is a required property for OutgoingInvoiceForm and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentDate is a required property for OutgoingInvoiceForm and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>postingDate (Buchungsdatum). </value>
        [DataMember(Name="postingDate", EmitDefaultValue=false)]
        public long PostingDate { get; set; }

        /// <summary>
        /// documentText (Rechnungstext).
        /// </summary>
        /// <value>documentText (Rechnungstext).</value>
        ...
        /// </summary>
        /// <value>locale (Sprache). If not provided by the user the language(Sprache) from the contact with the given \&quot;customerContactId\&quot; is used. To be set correctly in the invoice the locale must be also set in the Scopevisio client application under \&quot;Stammdaten\&quot; &gt; \&quot;Sprachen und Textbausteine\&quot; &gt; \&quot;Sprachen für Aufgragsbelege bearbeiten\&quot;. Otherwise the locale of the invoice is set to \&quot;Deutsch\&quot;.</value>
        [DataMember(Name="locale", EmitDefaultValue=false)]
        public string Locale { get; set; }

        /// <summary>
        /// currency(Währung), the ISO 4217 alphabetic currency code. If currency is provided there must be an exchange rate specified - either via the parameter \&quot;exchangeRate\&quot; or set in the Scopevisio client application. If currency is not provided, the currency from the contact with the given \&quot;customerContactId\&quot; is used.
        /// </summary>
        /// <value>currency(Währung), the ISO 4217 alphabetic currency code. If currency is provided there must be an exchange rate specified - either via the parameter \&quot;exchangeRate\&quot; or set in the Scopevisio client application. If currency is not provided, the currency from the contact with the given \&quot;customerContactId\&quot; is used.</value>
        [DataMember(Name="currency", EmitDefaultValue=false)]
        public string Currency { get; set; }

        /// <summary>
        /// exchangeRate(Wechselkurs), evaluated only if \&quot;curency\&quot; is set. If not provided in the request an exchange rate must be configured in the Scopevisio client application.
        /// </summary>
        /// <value>exchangeRate(Wechselkurs), evaluated only if \&quot;curency\&quot; is set. If not provided in the request an exchange rate must be configured in the Scopevisio client application.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OutgoingInvoiceForm {\n");
        ...
        {
            return this.Equals(input as OutgoingInvoiceForm);
        }

        /// <summary>
        /// Returns true if OutgoingInvoiceForm instances are equal
        /// </summary>
        /// <param name="input">Instance of OutgoingInvoiceForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OutgoingInvoiceForm input)
        {
            if (input == null)
                return false;
