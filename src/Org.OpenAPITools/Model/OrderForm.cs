...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrderForm :  IEquatable<OrderForm>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// state (Status des Auftrags). Sets also state.
        /// </summary>
        /// <value>state (Status des Auftrags). Sets also state.</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum StateNameEnum
        {
            /// <summary>
            /// Enum Erteilt for value: erteilt
            /// </summary>
            [EnumMember(Value = "erteilt")]
            Erteilt = 1,

            /// <summary>
            /// Enum Ausgeliefert for value: ausgeliefert
            /// </summary>
            [EnumMember(Value = "ausgeliefert")]
            Ausgeliefert = 2,
        ...
        /// <param name="stateName">state (Status des Auftrags). Sets also state..</param>
        /// <param name="locale">locale (Sprache).</param>
        public OrderForm(long projectId = default(long), long customerContactId = default(long), string name = default(string), string text = default(string), long customerContactPerson = default(long), long documentDate = default(long), string documentNumber = default(string), string ourContactPerson = default(string), string deliveryType = default(string), decimal deliveryCosts = default(decimal), decimal cashOnDelivery = default(decimal), string textTitle = default(string), string textSubTitle = default(string), string textIntro = default(string), string textExtro = default(string), long selectedAddress = default(long), string otherAddress = default(string), bool gross = false, long permissionType = default(long), string readPermissionProfiles = default(string), string readPermissionLogins = default(string), string writePermissionProfiles = default(string), string writePermissionLogins = default(string), List<CustomField> customFields = default(List<CustomField>), PositionsForm positionsForm = default(PositionsForm), long deliveryDate = default(long), long deliveryDateTo = default(long), bool isEndDiscountAbsolute = false, decimal endDiscount = default(decimal), PaymentTypeNameEnum? paymentTypeName = default(PaymentTypeNameEnum?), bool isPaid = false, long discountDate1 = default(long), long discountDate2 = default(long), long dueDate = default(long), decimal discountPercent1 = default(decimal), decimal discountPercent2 = default(decimal), bool explicitDiscount = false, decimal discountAmount1 = default(decimal), decimal discountAmount2 = default(decimal), string orderNumber = default(string), string zoneNumber = default(string), StateNameEnum? stateName = default(StateNameEnum?), string locale = default(string))
        {
            // to ensure "customerContactId" is required (not null)
            if (customerContactId == null)
            {
                throw new InvalidDataException("customerContactId is a required property for OrderForm and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("documentDate is a required property for OrderForm and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as OrderForm);
        }

        /// <summary>
        /// Returns true if OrderForm instances are equal
        /// </summary>
        /// <param name="input">Instance of OrderForm to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OrderForm input)
        {
            if (input == null)
                return false;
