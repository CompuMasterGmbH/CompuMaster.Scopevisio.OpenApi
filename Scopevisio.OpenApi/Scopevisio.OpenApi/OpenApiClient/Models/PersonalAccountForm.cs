...
namespace CompuMaster.Scopevisio.OpenScopeApi.Models
{
    ...
    public partial class PersonalAccountForm
    {
        /// <summary>
        /// Initializes a new instance of the PersonalAccountForm class.
        /// </summary>
        ...
        /// Initializes a new instance of the PersonalAccountForm class.
        /// </summary>
        public PersonalAccountForm(long? contactId = default(long?), string customerNumber = default(string), string email = default(string), string personalAccountNumber = default(string), long? numberRangeNumber = default(long?), string group = default(string), string vatCode = default(string), string paymentType = default(string), string vatNumber = default(string), string vatId = default(string), string currency = default(string), string language = default(string), long? paymentTermId = default(long?), PaymentTermForm paymentTermForm = default(PaymentTermForm))
        {
            ContactId = contactId;
        ...
        /// <summary>
        /// contactId (Kontakt Id), the id(Master Id) of the contact, to
        /// create a personal account for.
        /// Either valid contactId or customerNumber or email must be provided
        ...
        /// <summary>
        /// customerNumber, the customerNumber(Kontaktnummer) of the contact,
        /// to create a personal account for.
        /// Either valid contactId or customerNumber or email must be provided
        /// to create a personal account.
        /// </summary>
        ...
        /// <summary>
        /// email, the email(one of the existing seven possibilities
        /// E-Mail-Adresse[geschäftlich], E-Mail-Adresse[geschäftlich 2].
        /// etc.) of the contact, to create a personal account for.
        /// Either valid contactId or customerNumber or email must be provided
        /// to create a personal account.
        /// </summary>
        ...
        /// <summary>
        /// personalAccountNumber (Kontonummer), the wished number of the
        /// created personal account. If no numberRangeNumber provided, then
        /// the number range fitting for the personalAccountNumber is set.
        /// </summary>
